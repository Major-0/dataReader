...
void Vehicle::LogSD(){
  ...
  logfile.print(desired_speed_mmPs); logfile.print(" ");
  logfile.print(desired_brake);  logfile.print(" ");
  logfile.print(desired_angle);  logfile.print(" ");
  logfile.print(currentSpeed);  logfile.print(" ");
  logfile.print(currentBrake);  logfile.print(" ");
